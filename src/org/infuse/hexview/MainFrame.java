...
public class MainFrame extends JFrame {
  ...
  private void initGUI() throws IOException {
    ...
    tsp.setPreferredSize(new Dimension(_table.getPreferredSize().width+24, _table.getPreferredSize().height));
  ...
  private void chooseFiles() {
    try {
      ...
      if (desc != null) {
        List<String> lines = java.nio.file.Files.readAllLines(Paths.get(desc.getPath()), Charset.forName("UTF8"));
